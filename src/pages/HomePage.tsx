      ...
      <div className="max-w-6xl mx-auto px-4 pb-16">
        ...
        <div className="mb-12">
          {trendingLoading ? (
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">🔥 Trending Today</h2>
              <ErrorMessage
        ...
        <div className="mb-12">
          {popularLoading ? (
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">⭐ Most Popular</h2>
              <ErrorMessage
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <div className="text-center">
            <div className="w-16 h-16 mx-auto mb-4 bg-tmdb-secondary/10 rounded-full flex items-center justify-center">
              <svg className="w-8 h-8 text-tmdb-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Detailed Info</h3>
            <p className="text-gray-400">
